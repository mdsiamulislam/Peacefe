    ...
    <div class="min-h-screen bg-gray-50 py-12 px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                [
                'title' => 'Quran.com',
                'subtitle' => 'Read and listen to the Holy Quran online',
                'url' => 'https://quran.com',
                ],
                [
                'title' => 'Islamic Finder',
                'subtitle' => 'Prayer times, Qibla direction, Islamic calendar',
                'url' => 'https://www.islamicfinder.org',
                ],
                [
                'title' => 'Hadith Collection',
                'subtitle' => 'Authentic hadith from Bukhari, Muslim and others',
                'url' => 'https://sunnah.com',
                ],
                [
                'title' => 'Al Jazeera Islam Section',
                'subtitle' => 'News and articles about the Muslim world',
                'url' => 'https://www.aljazeera.com/tag/islam/',
                ],
                [
                'title' => 'Bangla Tafsir (Al Quran)',
                'subtitle' => 'Bangla translation and tafsir of Quran',
                'url' => 'https://alquranbd.com/',
                ],
                [
                'title' => 'Dua & Azkar',
                'subtitle' => 'Morning & Evening supplications',
                'url' => 'https://www.duas.com/',
                ],
                ];
                @endphp
                ...
                <div class="bg-white p-6 rounded-xl shadow hover:shadow-md transition-shadow border border-gray-100">
                    ...
                    <p class="text-sm text-gray-500 mb-4">{{ $link['subtitle'] }}</p>
